...
export const TrendingCoins = () => {
    ...
    return (
        <div className=' mx-auto w-auto md:w-[950px] p-6 mt-4  mb-10 '>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 gap-4 '>
                {
                    trending.map((coin, ids) => (
                        <div key={ids} className="flex flex-col items-center  mt-6 bg-slate-300 rounded-xl shadow-xl p-2 w-[170px] md:w-[250px] h-[270px] hover:translate-y-2 transition-all shadow-slate-400">
                            ...
                            <div className='flex flex-col md:flex-row items-center text-center justify-center gap-2 mt-4'>
                                <p className='font-bold' >Price: {coin.item.price_btc.toFixed(10)} </p>
